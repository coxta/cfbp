<div class="py-1">
    ...
    <div class="flex items-center space-x-4 py-2">
        ...
        <div class="flex items-center justify-end w-1/3 md:w-5/12 text-lg text-gray-900 font-bold">
            <div class="flex flex-col items-end">
                <div class="flex items-center">
                    ...
                    @endif
                    @if ($game->away_team > 0)
                        <a href="/teams/{{ $game->away_team }}" class="hover:text-blue-800">
        ...
        <!-- Status -->
        <div class="w-1/3 md:w-2/12 flex flex-col items-center space-y-2 text-xs tracking-tighter text-gray-600">
            <div class="font-semibold">{{ $game->status_detail_short }}</div>
            @if(!$game->completed)
        ...
        <div class="flex items-center justify-start w-1/3 md:w-5/12 text-lg text-gray-900 font-bold">
            ...
            <div class="flex flex-col items-start">
                ...
                <div class="flex items-center">
                    ...
                    @endif
                    @if ($game->home_team > 0)
                        <a href="/teams/{{ $game->home_team }}" class="hover:text-blue-800">
