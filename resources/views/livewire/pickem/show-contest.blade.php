<div>
                ...
                @foreach ($contest->selections as $selection)
                    <div class="flex flex-row items-center justify-between">
                        ...
                        <div class="flex flex-row items-center space-x-4 justify-end">
                            ...
                            <x-button wire:click="dropSelection('{{ $selection->game->id }}')" outline xs negative
                                label="Remove" />
                        </div>
                    </div>
                @endforeach
    ...
    @elseif(count($contest->selections) == 12 && $contest->status == 'Created')
        <div class="flex flex-col space-y-4 mt-3">
            <x-button label="View Selections" x-on:click="$openModal('contest-selections')" primary />
            ...
            @foreach ($dates as $date)
                ...
                <ul>
                    @forelse ($date['games'] as $game)
                        <li wire:click="selection('{{ $game->id }}')"
                            ...
                            <div class="flex justify-between space-x-4 py-3 px-2">
                                <div
                                    ...
                                    <div class="flex items-baseline justify-between">
                                        <p class="text-xs text-gray-500 font-semibold">{{ $game->status_detail_short }}
                                        </p>
