<div x-data="{ mobile: false, profile: false }">
    <div x-show="mobile" class="relative z-40 lg:hidden" role="dialog" aria-modal="true">
        <div x-show="mobile" x-transition:enter="transition-opacity ease-linear duration-300"
            x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100"
            x-transition:leave="transition-opacity ease-linear duration-300" x-transition:leave-start="opacity-100"
            x-transition:leave-end="opacity-0" class="fixed inset-0 bg-gray-900/80"></div>

        <div class="fixed inset-0 flex">
            <div x-show="mobile" x-transition:enter="transition ease-in-out duration-300 transform"
                x-transition:enter-start="-translate-x-full" x-transition:enter-end="translate-x-0"
                x-transition:leave="transition ease-in-out duration-300 transform"
                x-transition:leave-start="translate-x-0" x-transition:leave-end="-translate-x-full"
                class="relative mr-16 flex w-full max-w-xs flex-1">
                <div x-show="mobile" x-transition:enter="ease-in-out duration-300" x-transition:enter-start="opacity-0"
                ...
                <div class="flex grow flex-col overflow-y-auto bg-white px-6 pb-4">
                    ...
                    <nav class="flex flex-1 flex-col">
                        <ul role="list" class="flex flex-1 flex-col gap-y-7">
                            <!-- Pickem Routes -->
                            <li>
                                <div class="text-xs leading-6 text-muted mb-2 pb-0.5 border-b border-gray-200">Pickem
                                </div>
                            ...
                            <li>
                                <div class="text-xs leading-6 text-muted mb-2 pb-0.5 border-b border-gray-200">NCAA
                                    Football</div>
                                <ul role="list" class="ml-0.5 space-y-1">
                                    <li>
                                    ...
                                    <li>
                                        <x-nav-link :href="route('games')" :active="request()->routeIs('games') || request()->routeIs('game')">
                                            <img src="{{ secure_asset('img/nav-icons/scoreboard.svg') }}"
                                                class="h-5 w-5" />
                                            {{ __('Scoreboard') }}
                                        </x-nav-link>
                                    </li>
                                    <li>
                                        <x-nav-link :href="route('rankings')" :active="request()->routeIs('rankings')">
                                            <img src="{{ secure_asset('img/nav-icons/rankings.svg') }}"
                                                class="h-5 w-5" />
                                            {{ __('Rankings') }}
                                        </x-nav-link>
                                    </li>
                            ...
                            @admin
                                <li>
                                    <div class="text-xs leading-6 text-muted mb-2 pb-0.5 border-b border-gray-200">Admin
                                    </div>
        ...
        <div class="flex grow flex-col gap-y-5 overflow-y-auto border-r border-gray-200 bg-white px-6 pb-4">
            ...
            <nav class="flex flex-1 flex-col">
                <ul role="list" class="flex flex-1 flex-col gap-y-7">
                    ...
                    <li>
                        <div class="text-xs leading-6 text-muted mb-2 pb-0.5 border-b border-gray-200">NCAA Football
                        </div>
                        <ul role="list" class="ml-0.5 space-y-1">
                            <li>
                                <x-nav-link :href="route('home')" :active="request()->routeIs('home')">
            ...
            <div class="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
                ...
                @auth
                    <div class="flex items-center gap-x-4 lg:gap-x-6">
                        ...
                        <!-- Profile dropdown -->
                        <div class="relative">
                            <button @click="profile = !profile" type="button" class="-m-1.5 flex items-center p-1.5"
